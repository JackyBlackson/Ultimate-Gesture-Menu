...
public class GuiConfigs extends GuiConfigsBase
{
    ...
    public GuiConfigs()
    {
        super(10, 50, Reference.MOD_ID, null, "ultimate-gesture-menu.gui.title.configs");
    }
    ...
    {
        GENERIC ("ultimate-gesture-menu.gui.button.config_gui.generic"),
        TOGGLES ("ultimate-gesture-menu.gui.button.config_gui.toggles"),
        HOTKEYS ("ultimate-gesture-menu.gui.button.config_gui.hotkeys");
